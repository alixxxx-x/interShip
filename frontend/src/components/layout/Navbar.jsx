...
export default function Navbar({ children }) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-background text-foreground font-sans antialiased tracking-tight">
            <nav className={`fixed top-0 left-0 right-0 z-[100] bg-white border-b border-slate-100 shadow-sm transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
