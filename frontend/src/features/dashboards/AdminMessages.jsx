...
export default function AdminMessages() {
  ...
  // Fetch all companies to start a conversation
  ...
  return (
    <div className="p-6 h-[calc(100vh-100px)] flex flex-col gap-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">Direct communication channel with partner organizations.</p>
      </div>
              ...
              >
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <p className={cn(
                    ...
                    {company.company_field || "Partner Organization"}
                  </p>
                </div>
              </button>
            ))}
