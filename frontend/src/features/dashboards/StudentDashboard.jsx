    ...
    <div className="p-6 space-y-6 bg-background h-full animate-in fade-in duration-500" style={{ fontFamily: appleFont }}>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-gray-150 dark:border-zinc-800/80 rounded-xl shadow-sm overflow-visible">
        <div className="px-6 py-4 border-b border-gray-150 dark:border-zinc-800/80 flex items-center justify-between">
          <div>
            <h3 className="text-[15px] font-bold text-gray-900 dark:text-zinc-50 tracking-tight">Recent Applications</h3>
            <p className="text-[11px] font-medium text-gray-500 dark:text-zinc-400">The latest applications you applied for</p>
          </div>
          <button 
        ...
        {error ? (
          ...
          <div className="p-10 text-center flex flex-col items-center justify-center space-y-3 bg-gray-50/50 dark:bg-zinc-900/50 rounded-b-xl">
            ...
            <span className="text-[13px] font-medium text-gray-500 dark:text-zinc-400">No applications found.</span>
            ...
            <table className="w-full table-fixed border-collapse text-left">
              <thead>
                <tr className="bg-blue-50 dark:bg-zinc-900 border-b border-blue-100 dark:border-zinc-800">
                  <th className="text-[11px] font-bold tracking-wider text-blue-600 dark:text-blue-400 py-3.5 px-6 w-[40%]">Offer</th>
                  <th className="text-[11px] font-bold tracking-wider text-blue-600 dark:text-blue-400 py-3.5 px-4 w-[20%]">Company</th>
                  <th className="text-[11px] font-bold tracking-wider text-blue-600 dark:text-blue-400 py-3.5 px-4 w-[20%] text-center">Status</th>
                  <th className="text-[11px] font-bold tracking-wider text-blue-600 dark:text-blue-400 py-3.5 px-6 w-[20%] text-center">Applied Date</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[12px] font-medium text-gray-700 dark:text-zinc-200 truncate max-w-[120px]">
                          {application.companyName || application.company || "Corporate Partner"}
                        </span>
                      </div>
                    </td>
